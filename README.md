...
`--eliminate-unused-words`: Automatically remove words that are not used anywhere in your program. When a word is eliminated, all symbols inside word definition are ignored. More specifically, the compiler skips symbols until the word end marker `;` is found.
...
| Word              | Stack              | Description                                                             |
| ----------------- | ------------------ | ----------------------------------------------------------------------  |
| : \<name\>        | ( - )              | Start compiling a new word with name \<name\> ("colon definition")      |
| :M \<name\>       | ( - )              | Start compiling a new macro with name \<name\>                          |
| ;                 | ( - )              | Mark the end of word definition and stop compiling                      |
...
| INLINE            | ( - )              | Mark previous colon definition to be inlined                            |
| NOINLINE          | ( - )              | Prevent automatic inlining of previous colon definition                 |
...
| FIND \<name\>     | ( - addr )         | Push the compilation address of a word to compiler stack                |
